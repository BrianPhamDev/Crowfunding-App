...
const ContributionSummury = () => {
  return (
    <div className="w-full max-w-[462px] shadow-1 bg-white rounded-3xl pt-4 pb-10 px-5">
      ...
      <div className="flex items-center px-5 py-4 mb-4 rounded-xl bg-secondary-color/10 gap-x-4">
        <img
      ...
      <div className="px-5">
        <div className="flex items-center justify-between mb-3 text-base font-medium text-2">
          <span>Subtotal</span>
          <span>$2,724 USD</span>
        </div>
        <div className="flex items-center justify-between mb-6 text-base font-medium text-2">
          <span>Shipping</span>
          <span>$0 USD</span>
        </div>
