  ...
  return (
    <div className="flex items-center gap-x-5 mb-9">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="flex items-center text-sm gap-x-3 text-3">
          <strong className="text-primary-20">02 Campaign</strong>
          <span className="block w-[6px] h-[6px] rounded-full bg-3"></span>
