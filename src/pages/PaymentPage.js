  ...
  return (
    <div className="pt-[66px]">
      <div className="w-full max-w-[624px] mx-auto text-center">
        ...
        <p className="text-3 text-base mb-[60px]">
        ...
        <div className="grid grid-cols-[repeat(2,minmax(0,1fr))] space-x-10">
          <div className="bg-white shadow-1 flex flex-col justify-center items-center pt-[35px] px-6 pb-6 rounded-2xl w-full">
            <img srcSet="paypal.png 4x" alt="" className="mb-10" />
          ...
          <div className="bg-white shadow-1 flex flex-col justify-center items-center pt-[35px] px-6 pb-6 rounded-2xl w-full">
            <img srcSet="payoneer.png 4x" alt="" className="mb-10" />
            <p className="mb-6 text-sm text-3">Get paid worldwide your Work.</p>
            <Button className="w-full" kind="ghost">
              Connect
            </Button>
          </div>
